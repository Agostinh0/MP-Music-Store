...
public class FuncMenuController implements Initializable{
	@FXML
	private BorderPane mainScreen;

	@FXML
	public void funcOptionsButtonAction(ActionEvent event) {
		if(((Button)event.getSource()).getId().equals("clientButton")) {
			loadClienteStage();
		}
